...
Foam::autoPtr<Foam::chemistryTabulationMethodS<CompType, ThermoType>>
Foam::chemistryTabulationMethodS<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryTabulationMethodS<CompType, ThermoType>>
    (
