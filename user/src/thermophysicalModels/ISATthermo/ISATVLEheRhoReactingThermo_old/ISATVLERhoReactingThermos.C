...
namespace Foam
{
    ...
    using  ISATEmultithermo = species::ISATRhoMultithermo<Thermo, sensibleInternalEnergy>;

    template <class Thermo>
    using ISATVLERhoThermo = ISATEmultithermo<VLE<chungTransportMixture<PengRobinsonMixture<multispecie<Thermo>>>>>;
    ...
    (
        rhoThermo,
        rhoReactionThermo,
        ISATVLEheRhoReactingThermo,
        nLreactingMixtureISATRhoChungPR,
        VLEChungPREThermoPhysics
    );
