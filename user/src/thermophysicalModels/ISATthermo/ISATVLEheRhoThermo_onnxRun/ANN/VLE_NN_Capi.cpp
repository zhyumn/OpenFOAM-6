...
int main(){
    ...
    const char* saved_model_dir = "./ANN_model/"; // Path of the model
    ...
    auto duration1 = duration_cast<microseconds>(start); 
    cout << "start taken by function: " << duration1.count() << " microseconds" << endl;
    obj.predict(-5650.61,0.0011777777777777778,0.7156593087182554,0.2843406912817447);
    auto stop = high_resolution_clock::now();
    auto duration2 = duration_cast<microseconds>(stop);  
    cout << "stop taken by function: " << duration2.count() << " microseconds" << endl;
    auto duration3 = duration_cast<microseconds>(stop - start);
    cout << "Time taken by function: "<< duration3.count() << " microseconds" << endl;
