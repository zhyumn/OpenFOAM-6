...
Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::StandardChemistryModelS
(
...
:
    ...
    reactions_
    (
        dynamic_cast<const reactingMixtureS<ThermoType>&>(this->thermo())
    ),
    specieThermo_
    (
        dynamic_cast<const reactingMixtureS<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "StandardChemistryModelS: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::
...
template<class ReactionThermo, class ThermoType>
void Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::omega
(
    const scalarField& c,
    const scalar T,
    const scalar p,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalarField& c,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    scalarField& dcdt
...
template<class ReactionThermo, class ThermoType>
void Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    scalarField& dcdt,
...
Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::StandardChemistryModelS<ReactionThermo, ThermoType>::solve
(
