...
#include "foamChemistryReaderS.H"
#include "IFstream.H"
...
Foam::speciesTable& Foam::foamChemistryReaderS<ThermoType>::setSpecies
(
...
template<class ThermoType>
void Foam::foamChemistryReaderS<ThermoType>::readSpeciesComposition()
{
...
template<class ThermoType>
Foam::foamChemistryReaderS<ThermoType>::foamChemistryReaderS
(
