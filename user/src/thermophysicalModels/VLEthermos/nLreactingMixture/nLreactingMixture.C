...
Foam::nLreactingMixture<ThermoType,ThermoMixtureType>::nLreactingMixture
(
...
:
    ...
    nonlinearMixture<ThermoType,ThermoMixtureType>
    (
        thermoDict,
        *this,
...
template<class ThermoType,template<class> class ThermoMixtureType>
void Foam::nLreactingMixture<ThermoType,ThermoMixtureType>::read(const dictionary& thermoDict)
{}
