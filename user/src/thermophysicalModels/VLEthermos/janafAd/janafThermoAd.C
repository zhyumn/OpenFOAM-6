...
void Foam::janafThermoAd<EquationOfState>::checkInputData() const
{
    if (Tlow_ >= Thigh_)
    {
...
template<class EquationOfState>
Foam::janafThermoAd<EquationOfState>::janafThermoAd(const dictionary& dict)
:
...
template<class EquationOfState>
void Foam::janafThermoAd<EquationOfState>::write(Ostream& os) const
{
