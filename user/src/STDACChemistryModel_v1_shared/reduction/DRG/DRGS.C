...
Foam::chemistryReductionMethodSs::DRG<CompType, ThermoType>::DRG
(
    const IOdictionary& dict,
    STDACChemistryModel<CompType, ThermoType>& chemistry
)
:
    chemistryReductionMethodS<CompType, ThermoType>(dict, chemistry),
...
template<class CompType, class ThermoType>
void Foam::chemistryReductionMethodSs::DRG<CompType, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
