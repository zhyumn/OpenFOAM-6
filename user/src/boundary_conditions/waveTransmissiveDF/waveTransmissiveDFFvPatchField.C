...
#include "waveTransmissiveDFFvPatchField.H"
...
template<class Type>
Foam::waveTransmissiveDFFvPatchField<Type>::waveTransmissiveDFFvPatchField
(
    const fvPatch& p,
...
Foam::waveTransmissiveDFFvPatchField<Type>::waveTransmissiveDFFvPatchField
(
    const waveTransmissiveDFFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::waveTransmissiveDFFvPatchField<Type>::waveTransmissiveDFFvPatchField
(
    const waveTransmissiveDFFvPatchField& ptpsf
)
:
...
Foam::waveTransmissiveDFFvPatchField<Type>::advectionSpeed() const
{
...
template<class Type>
void Foam::waveTransmissiveDFFvPatchField<Type>::write(Ostream& os) const
{
