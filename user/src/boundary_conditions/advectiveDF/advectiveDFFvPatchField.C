...
#include "advectiveDFFvPatchField.H"
...
template<class Type>
Foam::advectiveDFFvPatchField<Type>::advectiveDFFvPatchField
(
    const fvPatch& p,
...
Foam::advectiveDFFvPatchField<Type>::advectiveDFFvPatchField
(
    const advectiveDFFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::advectiveDFFvPatchField<Type>::advectiveDFFvPatchField
(
    const advectiveDFFvPatchField& ptpsf
)
:
...
Foam::advectiveDFFvPatchField<Type>::advectionSpeed() const
{
...
template<class Type>
void Foam::advectiveDFFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    else
    {
        ...
        )
        {
            ...
            this->valueFraction() = 0.0/(1.0 + alpha);
        }
        else if (ddtScheme == fv::backwardDdtScheme<scalar>::typeName)
        {
            this->refValue() =
...
template<class Type>
void Foam::advectiveDFFvPatchField<Type>::write(Ostream& os) const
{
