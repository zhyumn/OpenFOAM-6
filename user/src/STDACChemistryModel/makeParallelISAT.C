...
#define makeParallelISATMethod(Comp, Thermo)                        \
                                                                               \
    typedef chemistryTabulationMethodSs::parallelISAT_chem<Comp, Thermo> parallelISAT_chem##Comp##Thermo;     \
                                                                               \
    ...
    chemistryTabulationMethodS<Comp, Thermo>::                                  \
        ...
        add##chemistryTabulationMethodSs##parallelISAT_chem##Comp##Thermo##ConstructorToTable_;
namespace Foam
{
