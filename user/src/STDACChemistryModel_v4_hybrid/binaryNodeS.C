...
Foam::binaryNodeS<CompType, ThermoType>::binaryNodeS()
:
    leafLeft_(nullptr),
    leafRight_(nullptr),
    nodeLeft_(nullptr),
...
Foam::binaryNodeS<CompType, ThermoType>::binaryNodeS
(
    chemPointISATS<CompType, ThermoType>* elementLeft,
    chemPointISATS<CompType, ThermoType>* elementRight,
    binaryNodeS<CompType, ThermoType>* parent
)
:
...
template<class CompType, class ThermoType>
void Foam::binaryNodeS<CompType, ThermoType>::calcV
(
    chemPointISATS<CompType, ThermoType>*& elementLeft,
    chemPointISATS<CompType, ThermoType>*& elementRight,
    scalarField& v
...
template<class CompType, class ThermoType>
Foam::scalar Foam::binaryNodeS<CompType, ThermoType>::calcA
(
    chemPointISATS<CompType, ThermoType>* elementLeft,
    chemPointISATS<CompType, ThermoType>* elementRight
)
