...
Foam::autoPtr<Foam::chemistryReductionMethodS<CompType, ThermoType>>
Foam::chemistryReductionMethodS<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryReductionMethodS<CompType, ThermoType>>
    (
