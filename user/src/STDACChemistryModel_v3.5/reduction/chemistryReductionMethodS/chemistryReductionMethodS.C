...
Foam::chemistryReductionMethodS<CompType, ThermoType>::chemistryReductionMethodS
(
    const Foam::IOdictionary& dict,
    Foam::STDACChemistryModel<CompType, ThermoType>& chemistry
)
:
    dict_(dict),
...
template<class CompType, class ThermoType>
Foam::chemistryReductionMethodS<CompType, ThermoType>::
