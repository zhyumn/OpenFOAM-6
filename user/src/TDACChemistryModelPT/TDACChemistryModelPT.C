...
Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::TDACChemistryModelPT
(
    ...
    )
{
    ...
    mechRed_ = chemistryReductionMethodPT<ReactionThermo, ThermoType>::New
    (
        *this,
        *this
    );
    ...
    tabulation_ = chemistryTabulationMethodPT<ReactionThermo, ThermoType>::New
    (
        *this,
        *this
    );
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    scalarField& dcdt
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    scalarField& dcdt,
...
Foam::scalar Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::solve
(
    const DeltaTType& deltaT
)
{
                        //FatalErrorInFunction << "test\n"<< exit(FatalError);
    ...
    forAll(rho, celli)
    {
        ...
        else
        {
            ...
            scalar timeTmp = 0;//clockTime_.timeIncrement();
            ...
            if (reduced)
            {
                ...
                nAvg++;
                scalar timeIncr = 0;//clockTime_.timeIncrement();
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACChemistryModelPT<ReactionThermo, ThermoType>::
