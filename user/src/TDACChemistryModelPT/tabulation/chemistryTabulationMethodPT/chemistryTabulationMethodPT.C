...
Foam::chemistryTabulationMethodPT<CompType, ThermoType>::chemistryTabulationMethodPT
(
...
template<class CompType, class ThermoType>
Foam::chemistryTabulationMethodPT<CompType, ThermoType>::
~chemistryTabulationMethodPT()
{}
