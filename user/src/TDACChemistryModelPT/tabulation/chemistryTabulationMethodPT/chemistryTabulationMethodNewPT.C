...
Foam::autoPtr<Foam::chemistryTabulationMethodPT<CompType, ThermoType>>
Foam::chemistryTabulationMethodPT<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryTabulationMethodPT<CompType, ThermoType>>
    (
