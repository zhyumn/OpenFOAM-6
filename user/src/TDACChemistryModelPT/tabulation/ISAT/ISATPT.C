...
Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::ISAT
(
    const dictionary& chemistryProperties,
    TDACChemistryModelPT<CompType, ThermoType>& chemistry
)
:
    chemistryTabulationMethodPT<CompType, ThermoType>
    (
        chemistryProperties,
        chemistry
    ),
    manager_(SUPstream::node_manager),
sync_(SUPstream::Sync),
...
template<class CompType, class ThermoType>
void Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::addToMRU
(
...
template<class CompType, class ThermoType>
void Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::calcNewC
(
    chemPointISAT<CompType, ThermoType>* phi0,
...
template<class CompType, class ThermoType>
bool Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::grow
(
    chemPointISAT<CompType, ThermoType>* phi0,
    const scalarField& phiq,
...
template<class CompType, class ThermoType>
bool
Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::cleanAndBalance()
{
...
template<class CompType, class ThermoType>
void Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::computeA
(
...
template<class CompType, class ThermoType>
bool Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::retrieve
(
...
template<class CompType, class ThermoType>
Foam::label Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::add
(
    const scalarField& phiq,
    const scalarField& Rphiq,
    const scalar rho,
...
template<class CompType, class ThermoType>
void
Foam::chemistryTabulationMethodsPT::ISAT<CompType, ThermoType>::writePerformance()
{
    if (this->log())
    {
        nRetrievedFile_()
