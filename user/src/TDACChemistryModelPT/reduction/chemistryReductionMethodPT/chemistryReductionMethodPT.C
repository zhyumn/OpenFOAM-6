...
Foam::chemistryReductionMethodPT<CompType, ThermoType>::chemistryReductionMethodPT
(
    const Foam::IOdictionary& dict,
    Foam::TDACChemistryModelPT<CompType, ThermoType>& chemistry
)
:
    dict_(dict),
...
template<class CompType, class ThermoType>
Foam::chemistryReductionMethodPT<CompType, ThermoType>::
~chemistryReductionMethodPT()
{}
