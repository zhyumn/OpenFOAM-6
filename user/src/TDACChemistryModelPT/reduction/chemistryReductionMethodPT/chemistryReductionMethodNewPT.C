...
#include "chemistryReductionMethodPT.H"
#include "Time.H"

// * * * * * * * * * * * * * * * * Selectors * * * * * * * * * * * * * * * * //

template<class CompType, class ThermoType>
Foam::autoPtr<Foam::chemistryReductionMethodPT<CompType, ThermoType>>
Foam::chemistryReductionMethodPT<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryReductionMethodPT<CompType, ThermoType>>
    (
