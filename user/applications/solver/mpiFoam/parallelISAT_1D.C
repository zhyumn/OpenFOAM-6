...
void Foam::ISAT_1D::leafData::set(const inputType& x, const outputType& y, Args ...args)
{
    v = x; Rv = y; computeA(x, y, A, args...); EOA = Foam::ISAT_1D::pISAT->tolerance() / max(fabs(A), 1);
}
template<typename ...Args>
